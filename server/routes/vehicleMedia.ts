...
import { upload, processUploadedFile, deleteFiles } from '../utils/fileUpload.js';
...
router.post('/:vehicleId/media', upload.array('images', 10), async (req: Request, res: Response) => {
  try {
    const vehicleId = parseInt(req.params.vehicleId);
...
router.put('/:vehicleId/media/:mediaId', async (req: Request, res: Response) => {
  try {
    const vehicleId = parseInt(req.params.vehicleId);
...
router.delete('/:vehicleId/media/:mediaId', async (req: Request, res: Response) => {
  try {
    const vehicleId = parseInt(req.params.vehicleId);
    const mediaId = parseInt(req.params.mediaId);
...
router.post('/:vehicleId/media/reorder', async (req: Request, res: Response) => {
  try {
    const vehicleId = parseInt(req.params.vehicleId);
