...
const AddVehiclePage = () => {
  ...
  const [priceSource, setPriceSource] = useState<"chocado" | "reparado">(
    "chocado",
  );
  ...
  const handleInputChange = (
    ...
    if (name.startsWith("admin_")) {
      ...
      setFormData((prev) => ({
        ...
        price:
          adminField === "costoVentaChocado" && priceSource === "chocado"
            ? value === ""
              ? 0
              : parseFloat(value)
  ...
  const addMediaField = () => {
    setMediaFiles([
      ...mediaFiles,
      { file: null, preview: "", type: "image", isPrimary: false },
    ]);
  };
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 shadow-lg">
              <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center">
                <span className="bg-yellow-400 text-yellow-900 px-2 py-1 rounded text-sm mr-3">
                  ADMIN
                </span>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 shadow-lg">
              <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center">
                <span className="bg-blue-400 text-blue-900 px-2 py-1 rounded text-sm mr-3">
                  PRECIO
                </span>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handlePriceSourceChange(
                        e.target.value as "chocado" | "reparado",
                      )
                    }
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    El precio del vehículo se tomará automáticamente del valor
                    seleccionado en la sección administrativa
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-600 mt-1">
                    💡 Este precio se actualiza automáticamente cuando cambias
                    los valores en la sección administrativa
                  </p>
                </div>
                ...
                <div className="bg-blue-100 border border-blue-300 rounded-lg p-4">
                  ...
                  <div className="text-sm text-blue-800">
                    <p>
                      ...
                      {priceSource === "chocado"
                        ? "Costo Venta Chocado"
                        : "Costo Venta Reparado"}
                    </p>
                    <p>
                      <strong>Valor en Admin:</strong> L.{" "}
                      {priceSource === "chocado"
                        ? (
                            formData.adminData?.costoVentaChocado || 0
                          ).toLocaleString()
                        : (
                            formData.adminData?.costoVentaReparado || 0
                          ).toLocaleString()}
                    </p>
                    <p className="mt-2 text-xs">
                      Para cambiar el precio, actualiza los valores en la
                      sección "Información Administrativa" arriba.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-lg">
              <h2 className="text-xl font-bold text-gray-900 mb-6">
                Imágenes y Videos del Vehículo
              </h2>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-blue-800 space-y-1">
                    <li>
                      • La primera imagen será la imagen principal del vehículo
                    </li>
                    <li>
                      • Puedes cambiar cuál es la imagen principal usando el
                      botón "Hacer Principal"
                    </li>
                    <li>
                      • Formatos soportados: JPG, PNG para imágenes | MP4, MOV
                      para videos
                    </li>
                    <li>• Tamaño máximo: 10MB por archivo</li>
                    <li>
                      • Archivos subidos:{" "}
                      {mediaFiles.filter((m) => m.file).length}
                    </li>
                  </ul>
                </div>
              </div>
