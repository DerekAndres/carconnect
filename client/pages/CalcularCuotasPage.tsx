      ...
      <div className="relative bg-gradient-to-r from-purple-600 to-purple-800 text-white">
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl font-bold mb-6">Calculadora de Cuotas</h1>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  <Label htmlFor="prima">
                    Prima Inicial (L.) -{" "}
                    {Math.round(
                      (calculatorData.primaInicial /
                        calculatorData.precioVehiculo) *
                        100,
                    )}
                    %
                  </Label>
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("primaInicial", Number(e.target.value))
                    }
                  ...
                  <Slider
                    value={[calculatorData.primaInicial]}
                    onValueChange={(value) =>
                      handleInputChange("primaInicial", value[0])
                    }
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("tasaInteres", Number(e.target.value))
                    }
                    className="text-lg mb-2"
                  />
                  <Slider
                    value={[calculatorData.tasaInteres]}
                    onValueChange={(value) =>
                      handleInputChange("tasaInteres", value[0])
                    }
                    min={8}
                    max={20}
                    step={0.1}
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleInputChange("plazoMeses", Number(value))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-sm space-y-1">
                        <div className="flex justify-between">
                          ...
                          <span>
                            L. {calculatorData.precioVehiculo.toLocaleString()}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span>Prima inicial:</span>
                          <span>
                            - L. {calculatorData.primaInicial.toLocaleString()}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span>Gastos legales:</span>
                          <span>
                            + L. {calculatorData.gastoLegal.toLocaleString()}
                          </span>
                        </div>
                        <Separator />
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="text-sm">
                          ...
                          <p className="text-yellow-700">
                            Esta es una simulación. Las tasas reales pueden
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          <Button
                            ...
                            variant="ghost"
                            onClick={() =>
                              handleInputChange("tasaInteres", banco.tasa)
                            }
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-gray-600">
                  Una prima mayor reduce significativamente tu cuota mensual y
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-gray-600">
                  Plazos más largos reducen la cuota mensual pero aumentan el
                  total de intereses.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-gray-600">
                  Solicita cotizaciones en diferentes bancos para encontrar la
