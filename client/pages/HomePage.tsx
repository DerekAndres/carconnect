...
import { Search, ChevronDown, ChevronLeft, ChevronRight, Menu, X } from 'lucide-react';
  ...
  const featuredVehicles = [
    {
      ...
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/e28089653b6c317d0fa42e451acf57fa40a3eb08?width=1152'
    },
    {
      id: 2,
      name: 'Toyota Camry',
      ...
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/47ee2adefddafdefb09a2c5fbaf8196601fb6ccc?width=930'
    },
    {
      id: 3,
      name: 'Toyota Camry',
      ...
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/430d90fb38e1cc61e90e68c5d685e31e7810d3e4?width=930'
    },
    {
      id: 4,
      name: 'Toyota Camry',
      ...
      price: 'L. 150,000',
      details: ['20 millas', 'Gasolina', 'Automatico'],
      image: 'https://api.builder.io/api/v1/image/assets/TEMP/3c48217fddaea0f514d06c9dca835959865ee3bc?width=1020'
    }
  ];

  const carTypes = [
    { name: 'SUV', image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/sedans.jpg' },
    { name: 'Sedan', image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/suvs.jpg' },
    { name: 'Pickup', image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/pickups.jpg' }
  ];
  ...
  const whyChooseUs = [
    {
      ...
      description: 'Nosotros nos encargamos de conseguir el mejor precio, evaluaré la mejor oferta bancaria, y te asesorare en los diferentes rubros para tu financiamiento.'
    },
    {
      icon: '🛡️',
      title: 'Empresa Confiable',
      description: 'Somos una empresa súper sólida, contable y responsable. Con años de experiencia y asesores que te ayudarán a elegir el automóvil ideal.'
    },
    {
      icon: '💰',
      title: 'Precios Transparentes',
      description: 'Tenemos precios súper accesibles y competitivos en todos nuestros automóviles que te ayudarán a generar la confianza que necesitas.'
    },
    {
      icon: '🔧',
      title: 'Servicios Expertos',
      description: 'Nuestros expertos están disponibles para revisar cualquier auto, ofrecemos servicio integral a nuestros clientes de inspección y reparación.'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16 bg-gray-50">
        <h2 className="text-3xl font-bold text-center mb-16">¿Por que nosotros?</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Nosotros nos encargamos de ayudarte a encontrar la mejor manera para que pagues tu auto. 
              Te podemos ayudar a conseguir financiamiento, o solo a calcularte cuanto quedaria tu cuota, 
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16 bg-blue-50">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto items-center">
          <div className="text-center lg:text-left">
            <h2 className="text-3xl font-bold mb-4">¿quieres cambiar tu auto?</h2>
            <h3 className="text-2xl font-medium mb-6">Tambien te ayudamos</h3>
            <p className="text-gray-700 mb-8 leading-relaxed">
              Estamos comprometidos a ofrecerles el mejor servicio, quieres cambiar tu carro, 
              mandanos tu informacion y te hacemos una cotizacion sin compromiso.
            </p>
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            <h3 className="text-2xl font-medium mb-8">SIGUE ESTOS SIMPLES PASOS</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-200 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">1</div>
                <p className="text-lg">Llena la información en el formulario.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-200 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">2</div>
                <p className="text-lg">Presiona el botón "Calcular"</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-200 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">3</div>
                <p className="text-lg">Mira la magia suceder</p>
              </div>
            </div>
          </div>
          
          <p className="text-blue-200 text-lg mb-8">el auto de tus sueños está más cerca de lo que piensas...</p>
